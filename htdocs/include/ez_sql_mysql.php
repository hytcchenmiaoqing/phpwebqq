	...
	*/
	...
	class ezSQL_mysql extends ezSQLcore
	{
		...
		*/
		...
		function quick_connect($dbuser='root', $dbpassword='123', $dbname='webqq', $dbhost='localhost')
		{
			$return_val = false;
		...
		*/
		...
		function connect($dbuser='root', $dbpassword='123', $dbname='webqq', $dbhost='localhost')
		{
